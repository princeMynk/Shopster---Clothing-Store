    ...
    return (
        <div className='pb-10'>
            <div class="flex flex-col items-center border-b bg-white py-4 sm:flex-row sm:px-10 lg:px-20 xl:px-32">
                <Link to="/" class="text-2xl font-bold font-protest text-gray-800">Shopster</Link>
                <div class="mt-4 py-2 text-xs sm:mt-0 sm:ml-auto sm:text-base">
                    <div class="relative">
                        <ul class="relative flex w-full items-center justify-between space-x-2 sm:space-x-4">
                            <li class="flex items-center space-x-3 text-left sm:space-x-4">
                                <Link to="/" class="flex h-6 w-6 items-center justify-center rounded-full bg-emerald-200 text-xs font-semibold text-emerald-700"
                            ...
                            <li class="flex items-center space-x-3 text-left sm:space-x-4">
                                <Link to="" class="flex h-6 w-6 items-center justify-center rounded-full bg-gray-600 text-xs font-semibold text-white ring ring-gray-600 ring-offset-2">2</Link>
                            ...
                            <li class="flex items-center space-x-3 text-left sm:space-x-4">
                                <Link to="" class="flex h-6 w-6 items-center justify-center rounded-full bg-gray-400 text-xs font-semibold text-white">3</Link>
            ...
            <div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
                <div class="px-4 pt-8">
                    ...
                    {items.map((item) => (
                        ...
                        <div class="mt-8 space-y-3 rounded-lg border border-black bg-white px-2 py-4 sm:px-6">
                            <div class="flex flex-col rounded-lg bg-white sm:flex-row">
                                <img class="m-2 h-24 w-28 rounded-md border object-cover object-center" src={item?.main_img} alt="" />
                                <div class="flex w-full flex-col px-4 py-4">
                                    <span class="font-semibold">{item?.name}</span>
                                    <p className='float-right'>
                                        <span class="text-gray-400">Size:</span> <span className='text-sm'>{item?.size}</span>
                                    </p>
                    ...
                    <form class="mt-5 grid gap-6">
                        <div class="relative">
                            ...
                            <label class="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" for="radio_1">
                                <img class="w-8 object-contain" src="https://i.postimg.cc/xjBwt2bD/fedex-logo-icon.png" alt="" />
                                <div class="ml-5">
                        ...
                        <div class="relative">
                            ...
                            <label class="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" for="radio_2">
                                <img class="w-8 object-contain" src="https://i.ibb.co/L8KSdNQ/image-3.png" alt="" />
                                <div class="ml-5">
                                    <span class="mt-2 font-semibold">DPD Delivery</span>
                ...
                <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0 h-fit">
                    ...
                    <div class="">
                        ...
                        <div class="flex flex-col sm:flex-row">
                            <div class="relative flex-shrink-0 sm:w-7/12">
                                ...
                                <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
                                    <img class="h-4 w-4 object-contain" src="https://i.postimg.cc/J7vzCvSM/india-flag.png" alt="" />
                                </div>
                            </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <p class="text-2xl font-semibold text-gray-900">₹{calculateTotalPrice() + 75}</p>
                        </div>
                    </div>
