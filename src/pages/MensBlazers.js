...
import MensWear from "../API/MenswearApi"
import { Link, useNavigate } from 'react-router-dom'

function MensBlazers() {
            ...
            <section className="text-gray-600 body-font">
                ...
                <div className="container px-9 sm:px-2 lg:px-1 pt-10 pb-24 mx-auto">
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-5 gap-3 items-center justify-center">
                        ...
                        {MensWear.MensBlazerData.map((item) => (
                            <div key={item.id} className="w-auto sm:w-[90%] lg:w-[235px] p-4 border-2 border-black my-2">
                                ...
                                <div className="mt-4">
                                    ...
                                    {/* Buy Now button */}
                                    <button onClick={() => NavToDetail(item)}
                                        className="bg-[#fff] hover:bg-black text-[#000] hover:text-white font-semibold py-1 px-1 w-full sm:py-1 sm:px-3 text-[13px] sm:text-base border-2 border-black " >
                                        Buy Now
                                    </button>
                                </div>
                            </div>
