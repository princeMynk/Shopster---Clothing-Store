...
function HomeCard() {
    return (
        ...
        // <div className="flex flex-wrap  items-center justify-evenly mt-10 mb-10 mx-5 ">
        //     {/* ============================================================================================================================================ */}
        //     <div className="shadow-lg card w-72 bg-gray-300 text-primary-content border-4 border-white hover:bg-[#b5b4b4] transition-all duration-300 ease-in-out">
        //         <CiDeliveryTruck className='mx-auto size-[40px] mt-2' color="black" />
        //         <div className="card-body items-center">
        //             <h2 className="card-title text-gray-700">FAST DELIVERY!</h2>
        //         </div>
        //     </div>
        //     {/* ============================================================================================================================================ */}
        //     <div className="shadow-lg card w-72 bg-gray-300 text-primary-content border-4 border-white hover:bg-[#b5b4b4] transition-all duration-300 ease-in-out">
        //         <BiSupport className='mx-auto size-[40px] mt-2' color="black" />
        //         <div className="card-body items-center">
        //             <h2 className="card-title text-gray-700">24/7 SUPPORT!</h2>
        //         </div>
        //     </div>
        //     {/* ============================================================================================================================================ */}
        //     <div className="shadow-lg card w-72 bg-gray-300 text-primary-content border-4 border-white hover:bg-[#b5b4b4] transition-all duration-300 ease-in-out">
        //         <BiSolidOffer className='mx-auto size-[40px] mt-2' color="black" />
        //         <div className="card-body items-center">
        //             <h2 className="card-title text-gray-700">GREAT DEALS!</h2>
        //         </div>
        //     </div>
        //     {/* ============================================================================================================================================ */}
        //     <div className="shadow-lg card w-72 bg-gray-300 text-primary-content border-4 border-white hover:bg-[#b5b4b4] transition-all duration-300 ease-in-out">
        //         <RiSecurePaymentLine className='mx-auto size-[40px] mt-2' color="black" />
        //         <div className="card-body items-center">
        //             <h2 className="card-title text-gray-700">SECURE PAYMENT!</h2>
        //         </div>
        //     </div>
        //     {/* ============================================================================================================================================ */}
        // </div>
