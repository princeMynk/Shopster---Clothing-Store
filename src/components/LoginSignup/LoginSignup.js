...
//                         <img src="https://floatui.com/logo-dark.svg" width={150} alt='img'/>
...
//                                 <img src="https://randomuser.me/api/portraits/women/79.jpg" alt='img' className="w-10 h-10 rounded-full border-2 border-white" />
//                                 <img src="https://api.uifaces.co/our-content/donated/xZ4wg2Xj.jpg" alt='img' className="w-10 h-10 rounded-full border-2 border-white" />
//                                 <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-0.3.5&q=80&fm=jpg&crop=faces&fit=crop&h=200&w=200&s=a72ca28288878f8404a795f39642a46f" alt='img' className="w-10 h-10 rounded-full border-2 border-white" />
//                                 <img src="https://randomuser.me/api/portraits/men/86.jpg" alt='img' className="w-10 h-10 rounded-full border-2 border-white" />
//                                 <img src="https://images.unsplash.com/photo-1510227272981-87123e259b17?ixlib=rb-0.3.5&q=80&fm=jpg&crop=faces&fit=crop&h=200&w=200&s=3759e09a5b9fbe53088b23c615b6312e" alt='img' className="w-10 h-10 rounded-full border-2 border-white" />
...
//                         <div className="">
//                             <img src="https://floatui.com/logo.svg" alt='img' width={150} className="lg:hidden" />
            ...
            <div class="flex flex-wrap">
                <div class="flex w-full flex-col md:w-1/2">
                    <div class="flex justify-center pt-12 md:-mb-24 md:justify-start md:pl-12">
                        <div class="border-b-gray-700 border-b-4 pb-2 text-2xl font-bold text-gray-900"> Damasus. </div>
                    </div>
                    <div class="lg:w-[28rem] mx-auto my-auto flex flex-col justify-center pt-10 md:justify-start md:px-6 md:pt-10">
                        ...
                        <button class="-2 mt-8 flex items-center justify-center rounded-md border px-4 py-1 outline-none ring-gray-400 ring-offset-2 transition focus:ring-2 hover:border-transparent hover:bg-black hover:text-white" onClick={googleSubmit}>
                            <img class="mr-2 h-5" src="https://static.cdnlogo.com/logos/g/35/google-icon.svg" alt="google icon" />
                            Log in with Google
                        </button>
                        ...
                        <form class="flex flex-col pt-3 md:pt-8">
                            <div class="flex flex-col pt-4">
                                <div class="focus-within:border-b-gray-500 relative flex overflow-hidden border-b-2 transition">
                                    <input type="email" name="email" class="w-full flex-1 appearance-none border-gray-300 bg-white px-4 py-2 text-base text-gray-700 placeholder-gray-400 focus:outline-none" placeholder="Email"
                            ...
                            <div class="mb-12 flex flex-col pt-4">
                                <div class="focus-within:border-b-gray-500 relative flex overflow-hidden border-b-2 transition">
                                    <input type="password" name="password" class="w-full flex-1 appearance-none border-gray-300 bg-white px-4 py-2 text-base text-gray-700 placeholder-gray-400 focus:outline-none" placeholder='🔐••••••'
                            ...
                            <button type="button" class="w-full rounded-lg bg-gray-900 px-4 py-2 text-center text-base font-semibold text-white shadow-md ring-gray-500 ring-offset-2 transition focus:ring-2" onClick={handleSubmit}>Log in</button>
                        </form>
                        <div class="py-12 text-center">
                            <p class="whitespace-nowrap text-gray-600">
                                Don't have an account?
                                <Link href="#" class="underline-offset-4 font-semibold text-gray-900 underline">Sign up for free.</Link>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="pointer-events-none relative hidden h-screen select-none bg-black md:block md:w-1/2">
                    <div class="absolute bottom-0 z-10 px-8 text-white opacity-100">
                        <p class="mb-8 text-3xl font-semibold leading-10">We work 10x faster than our compeititors and stay consistant. While they're bogged won with technical debt, we're releasing new features.</p>
                    ...
                    <img alt='bg img' class="-z-1 absolute top-0 h-full w-full object-cover opacity-90" src="https://images.unsplash.com/photo-1565301660306-29e08751cc53?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80" />
                </div>
            </div>
